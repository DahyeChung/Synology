...
public class MovingHazard : MonoBehaviour
{
    ...
    //private PlayerInventory playerInventory;  // Reference to the player's inventory (Commented out code for now)
    ...
    private void Start()
    {
        ...
        if (playerObject != null)
        {
            ...
            //playerInventory = playerObject.GetComponent<PlayerInventory>(); (Commented out code for now)
        }
    }
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.CompareTag("Player"))
        {
            ...
            {
                //playerInventory.RemoveItems(1); // Remove 1 item (Commented out code for now)
            }
        }
    }
}
